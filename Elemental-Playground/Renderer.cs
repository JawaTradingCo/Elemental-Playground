...
namespace Elemental_Playground
{
    class Renderer
    {
        public void Render(Graphics canvas, Simulation sim, int pixelSize, int width, int height, Point mousePosition,
        ...
        Bitmap GetSimulationFrame(Simulation sim, int pixelSize, int width, int height, Point mousePosition,
            int brushSize, int brushShape)
        {
